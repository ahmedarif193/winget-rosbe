 ...
 * Built during packaging and shipped in the winget bundle. Forwards all args
 * to rosbe.cmd in the same directory and inherits its exit code.
 *
...
int main(int argc, char **argv)
{
    ...
    if (!slash) {
        fprintf(stderr, "rosbe: failed to resolve install root\n");
        return 1;
    }
    *(slash + 1) = '\0';
